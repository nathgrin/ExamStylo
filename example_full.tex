...
%% Uncomment this to title on the worksheet
\ShowTitleOnTheWorksheet % < This
...
\ifdefined\makefulltitlepage
  \maketitlepage % inserts a \newpage
\else
  \ifdefined\makesimpletitlepage
