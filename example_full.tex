...
% Use \answer[pre][post]{answertxt} to insert answers
% For answers, use \begin{bolletjes}\item XXX \end{bolletjes} to list steps
%   Inside bolletjes, use \bolletje[pts]{} or \item
%          pts defaults to 1, leave empty for no points
%     this (\bolletje) currently does not work
